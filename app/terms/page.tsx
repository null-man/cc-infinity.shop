    ...
    <div className="container px-4 py-8 md:px-6 md:py-12 max-w-4xl">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
        <section>
          ...
          <p className="text-muted-foreground">Welcome to awesomeproducts-world. By accessing or using our website, you agree to be bound by these Terms of Service. If you do not agree to any part of these terms, please do not use our website.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-4">2. Service Description</h2>
          <p className="text-muted-foreground">awesomeproducts-world is an online fashion retail platform offering clothing, accessories, and related products. We reserve the right to modify, suspend, or discontinue services at any time without notice.</p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted-foreground">To the maximum extent permitted by law, awesomeproducts-world shall not be liable for any indirect, incidental, or consequential damages arising from use of our website. Our total liability shall not exceed the amount you paid for the products in question.</p>
        </section>

        <section>
          <h2 className="text-xl font-semibold mb-4">9. Contact Us</h2>
          <div className="text-muted-foreground">
            <p>Email: legal@awesomeproducts-world.com</p>
